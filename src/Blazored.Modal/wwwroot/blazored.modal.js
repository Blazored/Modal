...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'focus-trap'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var FocusTrap_js_1 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module './FocusTrap.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var BlazoredModal = /** @class */ (function () {
    ...
    BlazoredModal.prototype.setFocusTrap = function (element) {
        var trap = FocusTrap_js_1["default"](element, {});
        trap.activate({});
    };
