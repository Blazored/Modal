...
The following positioning styles are available out of the box: `Center`, `TopLeft`, `TopRight`, `BottomLeft` and `BottomRight`.

Use the `Position` parameter to set the position globally:

`<BlazoredModal Position="ModalPosition.BottomLeft" />`
